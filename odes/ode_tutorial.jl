...
# ╔═╡ f7e9e790-b552-11ec-06d8-63f2639f6b3f
using DifferentialEquations

# ╔═╡ fd842ff7-c8e3-44c1-8239-163914404c84
using Plots


# ╔═╡ e33ffd5f-0afb-4c01-9d55-ef71a96c665e
# https://diffeq.sciml.ai/dev/tutorials/ode_example/

# ╔═╡ cb3ced1a-7fa2-49b1-b94f-4df27f2d8e7a


# ╔═╡ a6f9fd8b-2c35-49b7-ade5-2597a3b59292


# ╔═╡ 680b2297-0a48-4fb1-96fc-44c451a978ca
f(u,p,t) = 1.01*u

# ╔═╡ 0ca1a43d-e71e-440b-afc3-c19ea7d6997c
u0 = 1/2

# ╔═╡ 6e9e2da9-8ff9-408b-8d2f-d920929c3d1c
tspan = (0.0,1.0)

# ╔═╡ 2c38de8b-08b9-49d8-bb6c-dc545f02c76f


# ╔═╡ 4b00a4f1-d668-45ae-bc4f-35d98ae7bcc2


# ╔═╡ 939a7b4d-8c10-48d8-ab50-a82d159895ab
# System of equations

# ╔═╡ 3a884720-4a17-43fa-a609-a79d23acd7d0
...
# ╔═╡ 34fc46ad-885f-40c4-8d61-081e0a50a335
begin
	u0 = [1.0;0.0;0.0]
	tspan = (0.0,100.0)
...
# ╔═╡ 89825f71-7b1a-4277-ae41-b2b9e2d698b0
prob = ODEProblem(f,u0,tspan)

# ╔═╡ 43d02db9-cf88-44ea-b4e2-8646c11fefc9
sol = solve(prob, Tsit5(), reltol=1e-8, abstol=1e-8)

# ╔═╡ 149b73f1-ee28-4ba5-a549-1d799242b249
plot(sol2,vars=(1,2,3))

# ╔═╡ b7854de2-8eb6-4c61-99a8-42ac08d45aa9
...
# ╔═╡ 405ca29b-3d0e-45f1-af98-4f5ecf05fa71
begin
	u0_V2 = [1.0,0.0,0.0]
	tspan_v2 = (0.0,1.0)
	p = [10.0,28.0,8/3]
	prob3 = ODEProblem(parameterized_lorenz!,u0_V2,tspan_v2,p)
end

# ╔═╡ 95ee1bc5-d48a-40bf-9320-fc38b96e4f32


# ╔═╡ d0f5be53-d90e-4ca1-8743-443d2dc8a0e6
# Pendulum problem

# ╔═╡ 60562ff3-a352-47ee-8cf2-4e3902883715
begin
	# using DifferentialEquations
	# using Plots
	...
	tspan5 = (0.0,10.0)                  # time interval
	
	M = t->0.1sin(t)                    # external torque [Nm]
	
	prob5 = ODEProblem(pendulum!,u₀,tspan,M)
	sol5 = solve(prob5)
	
	
end

# ╔═╡ a609e9b6-6690-491d-bdd5-e511e036fb07


# ╔═╡ aedf98f8-ca16-4160-92d1-99e763e63384
plot(sol5,linewidth=2,xaxis="t",label=["θ [rad]" "ω [rad/s]"],layout=(2,1))


# ╔═╡ d5bdf026-cc75-4143-b6f5-5f5397892b5f
plot(M)

# ╔═╡ 1919b12f-dbf8-4251-b53c-fa461858cc90


# ╔═╡ 18f60c6f-3899-41e3-a62b-851ffc928b61


# ╔═╡ ca5b2394-6d79-48b7-bebb-3499a029e95a


# ╔═╡ b4e710b4-83fb-4ada-9f70-f85c202b3a6c


# ╔═╡ 0be331f2-ffce-4800-a34a-89fdc2a90f4c
