...
# ╔═╡ 23dd4830-ea80-4c82-b912-1e2339b459b7
begin
	order = 1
...
# ╔═╡ 4374c48e-25d3-427f-b318-035eb90e76db
# begin
# 	i = 1
# 	name = "results$i"
# end

# ╔═╡ e2859210-296f-4982-907d-8c1291fc10cf
begin
	const E = 70.0e9
	const ν = 0.33
	...
	const μ = E/(2*(1+ν))
	for i in 1:10
	    g1(x) = VectorValue(0.05*i,0.0,0.0)
	    ...
	    writevtk(Ω,"results_$i",cellfields=["uh"=>uh,"epsi"=>ε(uh),"sigma"=>σ∘ε(uh)])
	end
end

# ╔═╡ ca4ea4cc-e137-404e-99a2-e24ae4ceeb99
...
git-tree-sha1 = "e39f162f663655158e2dc132124e1cea45c3afb4"
...
git-tree-sha1 = "c6c5aeb56853b9cb178fdb2e438991f8bbcddb70"
