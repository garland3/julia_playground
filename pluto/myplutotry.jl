...
# ╔═╡ 878475f7-1c46-4450-a688-df4b46bb8262
using Flux

# ╔═╡ 075ae442-d7d4-4579-b8df-3b1a8455a5ed
using CSV


# ╔═╡ e8ef27be-4197-498e-9461-8217957b05aa
using FileIO

# ╔═╡ bea3d3e5-47c3-4b5a-b9dc-f6b0503c2aef
using Images


# ╔═╡ f767b0dd-53b5-4623-b307-63bb73414589
using Plots


# ╔═╡ 61d13a09-bbeb-4dc6-a398-e22f934b2885
using PlutoUI


# ╔═╡ 75a38110-b098-11ec-18ca-5525e9a9aec3
a = 5

# ╔═╡ a2c7d1b0-2058-4819-b665-1e4730575ee0
b = 2

# ╔═╡ db4e76ff-707c-45d2-96e1-58772ece5a4c
c = a+b

# ╔═╡ f10d3d1a-1b17-4361-aa23-a7b654ad318d
d = c*3

# ╔═╡ 06b38e06-34a9-447c-832b-3eeab84e2d44
# begin

# end

# ╔═╡ 88657fb0-ea03-4873-bfad-c25c46f0cace
img = load(raw"C:\Users\garla\OneDrive\Desktop\skiing\Screenshot 2022-02-28 224543.png")


# ╔═╡ 626e161d-227e-4035-a17e-4bfa910231cc
x = collect(1:0.1:100)

# ╔═╡ ef89d28a-c0e8-414e-95ad-20195aabc344
@bind p Slider(-10:0.1:10)

# ╔═╡ 5e4e9ff5-8782-4f89-abac-22a6824b39e4
md"my p value is $p"

# ╔═╡ 7a301678-e0c8-4cd3-afe2-62e896a4ce18


# ╔═╡ b5ea810a-cd0a-44e9-b8fa-ca744ea18479


# ╔═╡ 3835067d-1e07-49af-a5d1-bcaa687e0ec5


# ╔═╡ b719890e-d662-4cdc-8923-14f4c3bbe241
y = sin.(x)+sin.(x*p/10)

# ╔═╡ 15f08286-f36d-4d87-954d-fe2633ca7471


# ╔═╡ 26d8ff96-2c96-439f-a931-4b8b9a02b11d
plot(x,y)

# ╔═╡ ee9d86bd-a996-490d-b4bf-5178c6bc62e8
# batch1 = img
size(img);

# ╔═╡ dda8dbcb-086a-4f77-be7b-1b2cc649ff12
begin
	# img2 =permutedims(channelview(img), (2,3,1));
	# img2 =;
	img2 = convert(Array{Float32}, permutedims(channelview(img),(2,3,1)));	
end

# ╔═╡ e9a2f12a-ae6c-4092-b53b-09c0538e896a


# ╔═╡ 7e13ab0f-d069-42be-9e20-b958b716fa59
size(img2)


# ╔═╡ 4d387cac-5f71-4bc2-b26a-986bb965d7b4


# ╔═╡ a280766a-76e8-495c-9ef6-d8674cf4d748
begin
...
# ╔═╡ 0955cfa6-9326-4849-bdcc-7c88cfdbc545
# typeof(img2)

# ╔═╡ 65e0edc7-ded6-4f1e-a969-4cd7799320ea
begin
	batch1 = add_dim(img2);
	size(batch1)
end

# ╔═╡ 7394e49e-4cfe-4ecc-9c15-0b60b7302beb
# @bind filter_size Scrubbable(1 : 25, default = 3)
@bind filter_size Slider(1 : 200, default = 3)


# ╔═╡ 285b971a-30e2-4696-92e9-7c05da2c9614
m = Chain(
	Conv((filter_size,filter_size), 4=>1),
	# Conv((3,3), 7=>1)
)

# ╔═╡ 18f4f5b7-d30b-4a34-8730-9b8e4585777a
img3 = m(batch1);

# ╔═╡ ebcaa89a-3508-4a37-a9c1-21b07d7b6942
# size(img3)
# img4 = reshape(size(img3)[0,1])
img4 = reshape(img3, size(img3)[1:2]);

# ╔═╡ 3e873672-2a2d-49b9-8017-0d5afd1d0636
img5 = img4[end:-1:1,:];

# ╔═╡ 3ea4d275-41c9-4657-acee-520dd37b6ebe
heatmap(img5, c =:bamako)

# ╔═╡ b5db7c64-4377-408c-99ec-59101861ce20
img

# ╔═╡ fe9222cc-ec85-42ee-8657-0e849092e086


# ╔═╡ 2a1f73a2-0063-4054-bf76-585de13b065a
# using Plots

# ╔═╡ 5a8c2935-3ee8-411b-a744-bfa5dfc94e81
